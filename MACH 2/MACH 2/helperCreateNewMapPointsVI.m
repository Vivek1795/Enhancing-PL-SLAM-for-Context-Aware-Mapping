function [G, pointToNode, mapPoints, vSetKeyFrames, recentPointIdx] = helperCreateNewMapPointsVI(...
    ...
    mapPoints, vSetKeyFrames, currKeyFrameId, intrinsics, scaleFactor, minNumMatches, minParallax, gDir, initIMU)
...
for i = 1:numel(KcIDs)
    ...
    if any(inlier)
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % if initIMU
        % xyzPoints = scale*gDir.transformPointsForward(xyzPoints);
        % end        
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
