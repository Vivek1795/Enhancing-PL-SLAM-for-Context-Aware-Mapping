...
for k = 1 : numCandidates
    ...
    [tform, inlierIndex] = estgeotform3d(...
        worldPoints2InCamera2, worldPoints1InCamera1, 'similarity', 'MaxDistance', 0.1);
    warning(w);
    ...
    if isempty(find(cViews==loopCandidates(k), 1))
        ...
        fPose=factorTwoPoseSE3([viewToNode(loopCandidates(k)) viewToNode(currKeyFrameId)],Measurement=fgRelPose);
        addFactor(G,fPose);
